<?php
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    $t_dsca=$_REQUEST['id_pais'];
    $t_idco=$_REQUEST['pais'];
    //$t_inac=$_REQUEST['nacionalidad'];
    $consult= "SELECT * FROM  trhcon001ex2 WHERE t_idco='$t_idco' AND t_dsca='$t_dsca";
    $resultad=$ConectaGraficas->tipoBD_query($consult,$ConexionGraficas); 
    $row=$ConectaGraficas->tipoBD_fetch_array($resultad);
     if ($row==0) {
              $insert="INSERT INTO trhcon001ex2 (t_dsca,t_idco) VALUES ('$t_dsca','$t_idco')";
...
<body>
        ...
        <!-- /.navbar-collapse -->
                  <h3 class="col-sm-12" class="form-signin-heading" align="center">Pa&iacute;s</h3>
                <br>
                <br> 
</div>
...
<td>
  ...
  <td>
      <input type="text" class="Radios" name="id_pais" id="id_pais" placeholder="id Pais">
  </td>
...
<tr>
  ...
  <td>
   <input type="text" name="pais" class="Radios" id="pais" placeholder="pais">
  </td>
</tr>
</table>
        <!-- -->
    ...
    <script type="text/javascript" languaje="javascript">
        ...
        {
            var arrayValidarDatos =["id_pais","pais"]
