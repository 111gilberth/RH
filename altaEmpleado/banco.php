...
<body>
<div>
                  <h3 class="col-sm-12" class="form-signin-heading" align="center">Banco</h3>
                     <tr>
                       </tr>  
                <br>
                <br> 
...
<table width="100%">
<td>
      <label for="id_max">ID sexo Max</label>
  </td>
  <td>
      <input type="text" class="ColorTextBox" name="id_max" id="id_max" placeholder="id sexo max">
  </td>
</tr>
<tr>
  <td>
