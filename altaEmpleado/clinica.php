<?php
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////////////////////
    $t_idsg=$_REQUEST['id_clinica'];
    $t_dsca=$_REQUEST['no_clinica'];
    $consult= "SELECT * FROM trhseg001ex2 WHERE t_idsg='$t_idsg' AND t_dsca='$t_dsca'";
    $resultad=$ConectaGraficas->tipoBD_query($consult,$ConexionGraficas); 
    $row=$ConectaGraficas->tipoBD_fetch_array($resultad);
     if ($row==0) {
              $insert="INSERT INTO trhseg001ex2 (t_idsg, t_dsca) VALUES ('$t_idsg','$t_dsca')";
...
<div>
                        ...
                        <h3 class="col-sm-12" class="form-signin-heading" align="center">Cl&iacute;nica</h3>
                         <tr>
                             </tr>  
                    <br>
                    <br> 
...
<tr>
  <td>
    <label for="id_clinica">ID max cl&iacute;nica</label>
  </td>
  <td>
    <input type="text" name="id_clinica" class="Radios" id="id_clinica" placeholder="ID max cl&iacute;nica">
  </td>
</tr>
<tr>
  <td>
  ...
  <td>
    <input type="text" class="Radios" name="no_clinica" id="no_clinica" placeholder="No. cl&iacute;nica">
  </td>
</tr>
</table>
        <!-- -->
    ...
    <script type="text/javascript" languaje="javascript">
        ...
        {
            var arrayValidarDatos =["id_clinica","no_clinica"]
