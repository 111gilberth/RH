<?php
    ...
    $consult= "SELECT * FROM trhedc001ex2 WHERE t_idec='$t_idec' AND t_dsca='$t_dsca'";
...
<body>
        ...
        <!-- /.navbar-collapse -->
                  ...
                  <h3 class="col-sm-12" class="form-signin-heading" align="center">Estado Civil</h3>
                     <tr>
                       </tr>  
                <br>
                <br> 
...
<div class="col-sm-4">
        ...
        form
        -->
        <form  id="form1" name="form2"  method="post" enctype="multipart/form-data">

<table width="100%">
<td>
      <label for="id_estado">ID Estado Civil</label>
  </td>
  <td>
      <input type="text" class="Radios" name="id_estado" id="id_estado" placeholder="id sexo max">
  </td>
</tr>
<tr>
  <td>
  ...
  <td>
   <input type="text" name="estado_civil" class="Radios" id="estado_civil" placeholder="Sexo">
  </td>
</tr>
</table>
        <!-- -->
