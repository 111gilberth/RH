...
<body>
        ...
        <!-- /.navbar-collapse -->
                  <h3 class="col-sm-12" class="form-signin-heading" align="center">G&eacute;nero</h3>
                <br>
                <br> 
</div>
...
<td>
      <label for="id_max">ID</label>
  </td>
  <td>
      <input type="text" class="Radios" name="id_max" id="id_max" placeholder="id sexo max">
  </td>
...
<tr>
  ...
  <td>
   <input type="text" name="sexo" class="Radios" id="sexo" placeholder="Sexo">
  </td>
</tr>
</table>
        <!-- -->
