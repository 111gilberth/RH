...
<tr>
  ...
  <td>
    <input type="text" name="id_clinica" id="id_clinica" placeholder="ID max cl&iacute;nica">
  </td>
</tr>
<tr>
  <td>
  ...
  <td>
    <input type="text" name="no_clinica" id="no_clinica" placeholder="No. cl&iacute;nica">
  </td>
</tr>
</table>
        <!-- -->
