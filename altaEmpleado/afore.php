...
<div class="col-sm-4">
        ...
        <table width="100%">
<td>
      <label for="id_afore">ID Afore</label>
  </td>
  <td>
      <input type="text" class="Radios" name="id_afore" id="id_afore" placeholder="ID Afore">
  </td>
...
<tr>
  ...
  <td>
   <input type="text" name="afore" class="Radios" id="afore" placeholder="Afore">
  </td>
</tr>
</table>
        <!-- -->
