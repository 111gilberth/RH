...
<div>
                        ...
                        <h3 class="col-sm-12" class="form-signin-heading" align="center">Jefe Inmediato</h3>
                         <tr>
                             </tr>  
                    <br>
                    <br> 
...
<tr>
    <td>
        <label for="id_inmediato">ID Jefe Inmediato</label>
    </td>
    <td>
        <input type="text" class="Radios" name="jefe" id="jefe" placeholder="Jefe Inmediato">
    </td>
</tr>
<tr>
  <td>
    <label for="clinica" >Jefe Inmediato</label>
  </td>
  <td>
   <input type="text" class="Radios" name="jefe_in" id="jefe_in" placeholder="Jefe Inmediato">
  </td>
</tr>
</table>
        <!-- -->
