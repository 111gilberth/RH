<?php
    ...
    ////////////////////////////////////////////////////////////////////////////////////////////////////////////
    $t_idus=$_REQUEST['user'];
    $t_idco=$_REQUEST['pais'];
    $t_idcd=$_REQUEST['ciudad'];
    $t_calle=$_REQUEST['calle'];
    $t_noex=$_REQUEST['ext'];
    $t_noin=$_REQUEST['int'];
    $t_czip=$_REQUEST['postal'];//||°°°"user","pais","ciudad","calle","ext","int","postal"
   /* $consult= "SELECT * FROM trhsex001ex2 WHERE t_idus='$t_idus'";
...
<div>
                        ...
                        <h3 class="col-sm-12" class="form-signin-heading" align="center">Ciudad de Origen</h3>
                         <tr>
                             </tr>  
                    <br>
                    <br> 
...
<td>
  ...
  <td>
      <input type="user" name="user" id="user" placeholder="ID Usuario">
  </td>
</tr>
<tr>
  <td>
  ...
  <td>
  <select  onchange="nuevaOpcion(this.value)" name="pais"
  id="pais">
       <!--Consulta sql--> 
            <?php
                $sqlGenero="select
            ...
            ?>
  <option value="otros_pais">Otros</option>
  </select>
  </td>
</tr>
<tr>
...
<td>
  <input type="text" name="ext" id="ext" placeholder="No. Exterior">
</td>
</tr>
<tr>
<td>
...
<td>
  <input type="text" name="int" id="int" placeholder="No. Interior">
</td>
</tr>
<tr>
<td>
  <label for="postal">Cod&iacute;go Postal</label>
</td>
<td>
  <input type="text" name="postal" id="postal" placeholder="Cod&iacute;go Postal">
</td>
</tr>
</table>
        <!-- -->
    ...
    <script type="text/javascript" languaje="javascript">
        ...
        {
            var arrayValidarDatos =["user","pais","ciudad","calle","ext","int","postal"]
